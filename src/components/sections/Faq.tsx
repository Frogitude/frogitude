          ...
          {faqs.map((item, idx) => (
            ...
            >
              <summary className="cursor-pointer list-none flex items-start justify-between gap-4">
                ...
                <span className="text-accent-lime group-open:rotate-180 transition-transform select-none text-xl">
                  ⌄
                </span>
              </summary>
              {item.a && (
                <p className="mt-4 text-text-secondary/95 leading-relaxed pl-0 border-l-2 border-accent-lime/30 ml-0 pl-4">
                  {item.a}
                </p>
              )}
            </motion.details>
