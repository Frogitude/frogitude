        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="hidden sm:block btn-gradient px-6 py-2 rounded-full font-semibold transition-all duration-300 transform hover:scale-105"
            >
              {t.nav.hire}
            </button>
            <button
          ...
          <div className="md:hidden mt-3 glass-effect rounded-2xl border border-border-primary p-4">
            <nav className="flex flex-col gap-2">
              ...
              <button
                ...
                className="mt-2 bg-gradient-to-r from-emerald-500 to-lime-600 text-white px-4 py-2 rounded-xl font-semibold"
              >
                {t.nav.hire}
              </button>
            </nav>
