...
export default function ChatWidget() {
  ...
  const texts = {
    de: {
      greet:
        "Hi! Frag mich gern etwas zu Frogitude, Unity/XR und unseren Leistungen. 🐸✨",
    ...
    en: {
      greet:
        "Hi! Ask me anything about Frogitude, Unity/XR, and our services. 🐸✨",
  ...
  async function send() {
    ...
    try {
      ...
      const answer =
        (data?.response as string) || "Sorry, keine Antwort verfügbar.";
  ...
  return (
    ...
    >
      {!open ? (
        ...
        <div
          className="w-[92vw] max-w-sm h-[65vh] max-h-[520px] glass-effect border border-border-primary rounded-2xl shadow-2xl flex flex-col overflow-hidden"
          role="dialog"
          aria-label={t.title}
        >
