            ...
            <section>
              ...
              <div className="space-y-1 text-text-secondary">
                ...
                <p>
                  ...
                  | Phone: +49 176 62031322
                </p>
                <p>Tax Number: 114/200/31825</p>
                <p>
                  Responsible for content according to § 55 Abs. 2 RStV: Fred
                  Newton Akdogan, Franz-Brombach-Str. 8a, 85435 Erding, Germany
                </p>
              </div>
              ...
              <p className="mt-4 text-text-secondary">
                ...
                these pages in accordance with general laws (§ 7 Abs.1 TMG).
                However, according to §§ 8 to 10 TMG, we are not obliged to
