        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="glass-effect rounded-3xl p-8 md:p-10 shadow-xl">
            ...
            <p className="text-text-secondary">
              ...
              process your data exclusively on the basis of the legal
              regulations (GDPR, TMG).
            </p>
            <p className="text-text-secondary mt-2">
              Controller: Fred Newton Akdogan, Franz-Brombach-Str. 8a, 85435
              Erding,{" "}
              <a
            ...
            <p className="text-text-secondary mt-2">
              When you visit this website, general information is automatically
              collected (e.g. IP address, browser used, operating system). This
              data does not allow any direct conclusions to be drawn about your
              person and is used exclusively for technical security and to
              improve the offer.
            </p>
            <p className="text-text-secondary mt-2">
              You have the right to information, correction, deletion,
              restriction, data portability and objection. If you believe that
              the processing of your data violates data protection law, you can
