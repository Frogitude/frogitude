  ...
  return (
    <div className="bg-bg-primary text-text-primary transition-colors duration-300 relative">
      <Head>
        ...
        <meta
          name="description"
          content="Unity Game & XR Developer — Frogitude (Fred Newton Akdogan)"
        />
          ...
          <div className="container mx-auto px-6 text-center">
            <div className="flex justify-center items-center gap-4 text-3xl font-black tracking-tightest mb-4">
              <img
                src={LOGO_URL}
                alt="Frogitude Logo"
                className="w-12 h-12 drop-shadow-[0_0_15px_var(--color-glow)]"
              />
            ...
            <div className="flex justify-center space-x-5 mb-8">
              {socialLinks.map(({ href, icon: Icon }) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-text-secondary hover:text-accent-lime transition-all duration-200 hover:scale-110"
                >
            ...
            <div className="text-sm text-text-secondary/60 space-x-4">
              <span>
                © {new Date().getFullYear()} Frogitude. All rights reserved.
              </span>
              <a
                href={withBasePath("/impressum")}
                className="underline hover:text-accent-lime transition-colors"
              >
                {t.footer?.imprintLabel || "Impressum"}
              </a>
              <a
              ...
              <a
                ...
                className="underline hover:text-accent-lime transition-colors"
              >
                {t.footer?.termsLabel || "Terms & Conditions"}
              </a>
              <span className="block mt-2 sm:mt-0 sm:inline">
                {t.footer?.techStackLine}
              </span>
            </div>
          </div>
        </footer>
